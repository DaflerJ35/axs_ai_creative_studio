/**
 * Momentum AI Creator — high-level job builders.
...
const isLocal = () => localStorage.getItem("momentum.useLocal") === "true";
...
export async function forgeVideoAsync(args: ForgeVideoArgs) {
  ...
  const endpoint = localStorage.getItem("momentum.videoEndpointId") || undefined;
