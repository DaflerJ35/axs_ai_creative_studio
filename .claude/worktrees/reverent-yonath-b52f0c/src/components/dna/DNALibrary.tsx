...
import {
  ...
  CheckCircle, Lock, Copy, Zap, ChevronRight,
} from "lucide-react";
...
export const DNALibrary = () => {
  const { characters, activeCharacterId, setActiveCharacter, deleteCharacter, setActiveTab } = useNyxStore();
                  ...
                  <GlassCard className="p-6 space-y-5 sticky top-24">
                    ...
                    {selectedChar.seed && (
                      <div className="flex items-center gap-2 p-3 rounded-xl bg-violet-500/10 border border-violet-500/30">
                        ...
                        <button
                          onClick={() => navigator.clipboard.writeText(String(selectedChar.seed))}
                          className="ml-auto"
                        >
